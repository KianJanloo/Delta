...
export const adminRoutes = [
  ...
  { label: "adminDocuments", href: "/dashboard/admin/documents", icon: FileText },
  ...
  { label: "adminDiscountCodes", href: "/dashboard/admin/discount-codes", icon: Percent },
  { label: "adminSocialMedias", href: "/dashboard/admin/social-medias", icon: Share2 },
