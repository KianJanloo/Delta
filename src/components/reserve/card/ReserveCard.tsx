...
const ReserveCard: FC<IReserveContent> = ({ items }) => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row w-full border-b-2 bg-transparent py-6 items-center group justify-between border-[#3B3B3B]"
    >
      ...
      <div className="flex flex-col justify-end gap-4 h-full items-center md:w-1/5 w-full mt-4 md:mt-0">
        {hasDiscount ? (
